...
CREATE TABLE IF NOT EXISTS knowledge_base (
    ...
    file_type VARCHAR(50), -- pdf, txt, csv, json, etc.
...
COMMENT ON COLUMN knowledge_base.content IS 'Searchable text content extracted from files';
COMMENT ON COLUMN knowledge_base.metadata IS 'Additional info: tags, summary, category, etc.';
